  ...
  >
    ...
    <g id="_\uC0C9" data-name="\uC0C9">
      <path
        ...
        d="M436.15,507.9c-2.18-.97-4.2-1.91-6.26-2.76-.66-.28-1.62-1.13-2.09-.17-.51,1.05,.8,1.31,1.46,1.63,4.92,2.35,9.88,4.62,14.8,6.97,.45,.22,.92,.76,1.05,1.23,1.81,6.86,3.57,13.73,5.34,20.6,.15,.57,.31,1.14,.49,1.79-.95,0-1.78,0-2.61,0-16.08,.01-32.17,.03-48.25,.05-.96,0-1.92,.04-2.87,.13-.86,.08-1.1-.31-1.15-1.09-.23-4.14-.48-8.28-.73-12.42-.18-2.98-.37-5.96-.56-9,3.01,.48,5.73-.18,8.37-1.21,2.85-1.1,4.76-3.1,5.62-6.09,1.55-5.41,2.1-10.95,2.17-16.55,0-.47,0-.94,0-1.61h25.23v18.5Z"
      />
      <path
        className="cls-1"
        style={{ fill: main, filter: `brightness(${sub}%)` }}
        d="M471.4,489.68c.5,3.67,.89,7.23,1.49,10.75,.34,1.99,.9,3.97,1.56,5.88,1.64,4.77,4.88,7.85,9.89,8.95,3.72,.82,7.45,1.4,11.22,.44,1.55,6.43,3.1,12.86,4.67,19.41-1.69,.17-3.46,.37-5.24,.52-8.79,.75-17.58,1.43-26.36,2.25-4.45,.41-8.88,1.03-13.31,1.59-1.87,.23-1.89,.27-2.43-1.57-1.27-4.28-2.58-8.55-3.77-12.85-.93-3.33-1.71-6.71-2.62-10.33,.59,.25,.97,.39,1.34,.57,4.73,2.3,9.46,4.61,14.2,6.9,.42,.2,.91,.36,1.37,.38,.29,0,.74-.24,.83-.48,.09-.24-.09-.69-.3-.92-.22-.25-.61-.36-.93-.52-5.37-2.62-10.75-5.24-16.11-7.89-.27-.14-.56-.58-.56-.89-.03-7.3-.03-14.6-.03-21.9,0-.08,.04-.15,.08-.3h25.02Z"
      />
      <path
        className="cls-1"
        style={{ fill: main }}
        d="M392.12,553.12v-14.23c1.7,0,3.39,0,5.09,0,14.25,.02,28.5,.05,42.75,.07,3.55,0,7.11,0,10.66-.05,.68,0,1.03,.21,1.18,.87,.65,2.87,1.55,5.68,1.27,8.7-.14,1.49-.02,3.01-.02,4.63h-60.92Z"
      />
      <path
        className="cls-1"
        style={{ fill: main }}
        d="M457.28,554.68c-1.17-4.61-2.28-9-3.41-13.45,16.6-2.48,33.31-2.97,50.15-4.66,1.28,4.28,2.58,8.62,3.98,13.32-16.99,1.92-33.84,2.77-50.72,4.79Z"
      />
      <path
        className="cls-1"
        style={{ fill: main, filter: `brightness(${detail}%)` }}
        d="M491.79,476.5c.17,3.94,.32,7.71,.49,11.62h-45.99v-10.8c.07-.03,.21-.11,.36-.13,6.03-.59,12.08-.62,18.13-.59,8.26,.04,16.52,.01,24.78,0,.67,0,1.34-.07,2.23-.11Z"
      />
      <path
        className="cls-1"
        style={{ fill: main, filter: `brightness(${detail}%)` }}
        d="M395.48,488.06c.24-3.09,.46-5.99,.7-8.88,.22-2.63,.23-2.59,2.84-2.58,8.26,.02,16.51-.04,24.77,.04,3.7,.04,7.4,.4,11.1,.55,1.21,.05,1.49,.53,1.45,1.69-.1,3.05-.03,6.11-.03,9.18h-40.83Z"
      />
      <path
        className="cls-1"
        style={{ fill: main, filter: `brightness(${detail}%)` }}
        d="M473.07,489.64c1.98,0,3.65,0,5.32,0,4.31,0,8.61,0,12.92-.03,.84,0,1.13,.2,1.24,1.1,.89,7.51,1.85,15.01,2.78,22.52,.03,.27,0,.54,0,.83-4.29,.89-8.44,.22-12.49-1.09-2.65-.86-4.59-2.68-5.85-5.17-1.84-3.65-2.51-7.62-3.1-11.61-.31-2.11-.54-4.24-.83-6.56Z"
      />
      <path
        className="cls-1"
        style={{ fill: main, filter: `brightness(${detail}%)` }}
        d="M409.35,489.53c0,1.49,.06,2.95-.01,4.42-.23,4.34-.72,8.65-1.84,12.88-.78,2.94-2.55,4.87-5.4,5.7-1.74,.51-3.59,.68-5.39,.98-.61,.1-1.23,.14-1.94,.22-.05-.57-.15-1.2-.14-1.82,.21-7.21,.44-14.42,.66-21.63,.02-.57,.16-.88,.81-.88,4.31,.03,8.62,.03,12.93,.05,.11,0,.22,.07,.31,.1Z"
      />
      <path
        className="cls-1"
        style={{ fill: main, filter: `brightness(${sub}%)` }}
        d="M437.74,477.34h7.07v34.47c-2.36-1.05-4.54-1.98-6.67-3.02-.27-.13-.38-.82-.39-1.25,0-6.82,.02-13.64,.02-20.47,0-2.75-.02-5.51-.03-8.26,0-.43,0-.86,0-1.49Zm5.75,5.37c-.02-1.09-1.45-2.57-2.45-2.53-1,.04-1.95,1.19-1.96,2.35,0,1.33,1.05,2.46,2.26,2.44,1.18-.02,2.16-1.06,2.14-2.26Z"
      />
      <path
        className="cls-1"
        style={{ fill: main, filter: `brightness(${sub}%)` }}
        d="M441.21,481.52l.84,1.72c-.36,.12-.86,.44-1.07,.31-.73-.46-.67-1.15-.26-1.81,.16-.07,.32-.15,.49-.22Z"
      />
    </g>
    <g id="_\uC120" data-name="\uC120">
